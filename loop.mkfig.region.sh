...
#    echo "./camaflood_post_vis_nc.py $EXP $CDATE_1"
#    ./camaflood_post_vis_nc.py $EXP $CDATE_1
    echo "./camaflood_post_vis_nc_region.py $EXP $CDATE_1 $REGION $LON1 $LON2 $LAT1 $LAT2"
    ./camaflood_post_vis_nc_region.py $EXP $CDATE_1 $REGION $LON1 $LON2 $LAT1 $LAT2
    if [ $SCHH == "06" ]; then
	if [ $INIT_OUT_FLAG == "EC" ]; then
	    echo "ec_rotp_aws.sh $CDATE_0"
	    ./ec_rotp_aws.sh $CDATE_0
        ...
        elif [ $INIT_OUT_FLAG == "TE" ]; then
	    echo "te_rotp_aws.sh $CDATE_0"
	    ./te_rotp_aws.sh $CDATE_0
