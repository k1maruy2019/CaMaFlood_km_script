...
BASE_0="/usr/amoeba/pub/CaMaFlood"
...
YMD_END=$3
DATA_DIR=$4
IFRQ_INP_0=$5                                # input forcing frequency: [1,2,3,...,24] hour
#DROFUNIT="3600000"   # [mm/hr->m/s]         # runoff unit conversion
#DROFUNIT="10800000"   # [mm/3hr->m/s]                # runoff unit conversion (maruyam Edit)
DROFUNIT_0=$6
RDIRPRE=$7
RDIRPRE=${BASE_0}/${RDIRPRE}
echo $RDIRPRE
...
IFRQ_INP="3"                                # input forcing frequency: [1,2,3,...,24] hour
IFRQ_INP=$IFRQ_INP_0                        # input forcing frequency: [1,2,3,...,24] hour
#DROFUNIT="3600000"   # [mm/hr->m/s]         # runoff unit conversion
DROFUNIT="10800000"   # [mm/3hr->m/s]                # runoff unit conversion (maruyam Edit)
DROFUNIT=$DROFUNIT_0
...
CROFDIR="${BASE_0}/inp/${DATA_DIR}/"         # runoff directory  ( maruya Edit)
...
do
  CDATE="${SDATE}${SCHH}"
  RDIR=${BASE_0}/out/${EXP}/${CDATE}                     # directory to run CaMa-Flood
